...
namespace FPTJob_1670.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,SenderId,ReceiverId,SentAt")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,SenderId,ReceiverId,SentAt")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
